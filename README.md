...
git clone https://github.com/zarishsphere/zs-svc-maternity.git
cd zs-svc-maternity
...
See [docs.zarishsphere.com/api/zs-svc-maternity](https://docs.zarishsphere.com/api/zs-svc-maternity) for the full OpenAPI 3.1 specification.
